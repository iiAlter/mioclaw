/**
 * Twitch channel plugin for Mioclaw.
 *
...
import { buildChannelConfigSchema } from "mioclaw/plugin-sdk/twitch";
 ...
 * for Mioclaw. Supports message sending, receiving, access control, and
 * status monitoring.
 */
