...
import type { OpenClawPluginApi } from "mioclaw/plugin-sdk/diffs";
import { resolvePreferredOpenClawTmpDir } from "mioclaw/plugin-sdk/diffs";
import {
...
const plugin = {
  ...
  register(api: OpenClawPluginApi) {
    ...
    const store = new DiffArtifactStore({
      rootDir: path.join(resolvePreferredOpenClawTmpDir(), "mioclaw-diffs"),
      logger: api.logger,
    });
