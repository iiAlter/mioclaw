import { AllowFromListSchema, DmPolicySchema } from "mioclaw/plugin-sdk/compat";
import { MarkdownConfigSchema, buildChannelConfigSchema } from "mioclaw/plugin-sdk/nostr";
import { z } from "zod";
