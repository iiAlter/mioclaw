...
import { fetchWithSsrFGuard } from "mioclaw/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Mioclaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".mioclaw", "workspace", "media", "inbound");
 ...
 * Format matches Mioclaw's expected attachment structure.
 */
