...
import type { OpenClawPluginApi } from "mioclaw/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("mioclaw/plugin-sdk/mattermost").OpenClawConfig;
    runtime: import("mioclaw/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
