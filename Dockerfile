...
COPY --from=runtime-assets --chown=node:node /app/mioclaw.mjs .
...
RUN ln -sf /app/mioclaw.mjs /usr/local/bin/mioclaw \
 && ln -sf /app/openclaw.mjs /usr/local/bin/openclaw \
 && chmod 755 /app/mioclaw.mjs /app/openclaw.mjs
...
CMD ["node", "mioclaw.mjs", "gateway", "--allow-unconfigured"]
