...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = MioclawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = MioclawConfigFile.url()
    ...
    private func applyConfigFromDisk() {
        let root = MioclawConfigFile.loadDict()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: MioclawConfigFile.loadDict(),
        ...
        MioclawConfigFile.saveDict(synced.root)
    }
