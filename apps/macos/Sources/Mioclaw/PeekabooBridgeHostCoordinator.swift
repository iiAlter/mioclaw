...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "ai.mioclaw", category: "PeekabooBridge")
    ...
    private static var openclawSocketPath: String {
        ...
        return Self.makeSocketPath(for: "Mioclaw", in: base)
    }
...
private final class OpenClawPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "ai.mioclaw.peekaboo")
