...
enum ExecApprovalsStore {
    ...
    static func fileURL() -> URL {
        MioclawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        MioclawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
    ...
    private static func ensureSecureStateDirectory() {
        let url = MioclawPaths.stateDirURL
        do {
