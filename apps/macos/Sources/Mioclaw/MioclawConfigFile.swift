...
enum MioclawConfigFile {
    private static let logger = Logger(subsystem: "ai.mioclaw", category: "config")
    private static let configAuditFileName = "config-audit.jsonl"

    static func url() -> URL {
        MioclawPaths.configURL
    }

    static func stateDirURL() -> URL {
        MioclawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        MioclawPaths.workspaceURL
    }
