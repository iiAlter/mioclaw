...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    memory: "Memory board and knowledge base.",
    skills: "Skills and API keys.",
    nodes: "Paired devices and commands.",
    chat: "Gateway chat for quick interventions.",
    config: "Edit mioclaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from mioclaw dashboard --no-open on your desktop.",
    },
    insecure: {
