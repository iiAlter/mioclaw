...
// Stub types for removed channels
type StubChannel = Record<string, unknown>;
...
export type PluginRuntimeChannel = {
  ...
  // Removed channels: discord, slack, signal, imessage, line
  discord: StubChannel;
  slack: StubChannel;
  signal: StubChannel;
  imessage: StubChannel;
  line: StubChannel;
  telegram: {
