...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@mioclaw", { botUsername: "mioclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@mioclaw args", {
        botUsername: "mioclaw",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "mioclaw" })).toBe(
      "/help@otherbot",
    );
  });
