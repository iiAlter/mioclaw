...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.mioclaw.gateway\n";
...
describe("launchd bootstrap repair", () => {
  it("enables, bootstraps, and kickstarts the resolved label", async () => {
    ...
    const label = "ai.mioclaw.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.mioclaw.ai/gateway");
  });
  ...
  it.each([
    {
      ...
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.mioclaw.gateway.plist",
    },
    {
      ...
      expected: "/Users/test/Library/LaunchAgents/ai.mioclaw.jbphoenix.plist",
    },
    {
    ...
    },
    {
      ...
      expected: "/Users/test/Library/LaunchAgents/ai.mioclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
