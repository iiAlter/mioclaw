...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.mioclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("mioclaw hooks list")}`,
      `  ${formatCliCommand("mioclaw hooks enable <name>")}`,
      `  ${formatCliCommand("mioclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
