...
// Stubs for removed channels
export function resolveIMessageConfigAllowFrom(_account: unknown): string[] {
  return [];
}

export function resolveIMessageConfigDefaultTo(_account: unknown): string | null {
  return null;
}

export function formatWhatsAppConfigAllowFromEntries(_entries: string[]): string[] {
  return [];
}

export function resolveWhatsAppConfigAllowFrom(_account: unknown): string[] {
  return [];
}

export function resolveWhatsAppConfigDefaultTo(_account: unknown): string | null {
  return null;
}
