...
export const DEFAULT_SANDBOX_IMAGE = "mioclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "mioclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "mioclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "mioclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "mioclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "mioclaw-sandbox-browser";
