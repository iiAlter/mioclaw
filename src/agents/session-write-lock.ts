...
const CLEANUP_STATE_KEY = Symbol.for("mioclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("mioclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("mioclaw.sessionWriteLockWatchdogState");
