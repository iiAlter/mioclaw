...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("mioclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "mioclaw");
