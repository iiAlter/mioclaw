    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mioclaw channels list", "List configured channels and auth profiles."],
          ["mioclaw channels status --probe", "Run channel status checks and probes."],
          [
            "mioclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["mioclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.mioclaw.ai/cli/channels",
        )}\n`,
    );
