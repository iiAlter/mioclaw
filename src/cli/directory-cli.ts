    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mioclaw directory self --channel slack", "Show the connected account identity."],
          [
            'mioclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["mioclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "mioclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.mioclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
