...
const SANDBOX_EXAMPLES = {
  main: [
    ["mioclaw sandbox list", "List all sandbox containers."],
    ["mioclaw sandbox list --browser", "List only browser containers."],
    ["mioclaw sandbox recreate --all", "Recreate all containers."],
    ["mioclaw sandbox recreate --session main", "Recreate a specific session."],
    ["mioclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["mioclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["mioclaw sandbox list", "List all sandbox containers."],
    ["mioclaw sandbox list --browser", "List only browser containers."],
    ["mioclaw sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["mioclaw sandbox recreate --all", "Recreate all containers."],
    ["mioclaw sandbox recreate --session main", "Recreate a specific session."],
    ["mioclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["mioclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["mioclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["mioclaw sandbox explain", "Show effective sandbox config."],
    ["mioclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["mioclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["mioclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.mioclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
